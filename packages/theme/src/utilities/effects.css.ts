...
globalStyle('.shadow-xl', {
  boxShadow:
    '0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)',
});
globalStyle('.shadow-2xl', {
  boxShadow: '0 25px 50px -12px rgb(0 0 0 / 0.25)',
});
globalStyle('.shadow-inner', {
  boxShadow: 'inset 0 2px 4px 0 rgb(0 0 0 / 0.05)',
});
globalStyle('.shadow-none', { boxShadow: '0 0 #0000' });

// Drop shadow utilities
globalStyle('.drop-shadow-sm', {
  filter: 'drop-shadow(0 1px 1px rgb(0 0 0 / 0.05))',
});
globalStyle('.drop-shadow', {
  filter:
    'drop-shadow(0 1px 2px rgb(0 0 0 / 0.1)) drop-shadow(0 1px 1px rgb(0 0 0 / 0.06))',
});
globalStyle('.drop-shadow-md', {
  filter:
    'drop-shadow(0 4px 3px rgb(0 0 0 / 0.07)) drop-shadow(0 2px 2px rgb(0 0 0 / 0.06))',
});
globalStyle('.drop-shadow-lg', {
  filter:
    'drop-shadow(0 10px 8px rgb(0 0 0 / 0.04)) drop-shadow(0 4px 3px rgb(0 0 0 / 0.1))',
});
globalStyle('.drop-shadow-xl', {
  filter:
    'drop-shadow(0 20px 13px rgb(0 0 0 / 0.03)) drop-shadow(0 8px 5px rgb(0 0 0 / 0.08))',
});
globalStyle('.drop-shadow-2xl', {
...
[0, 50, 100].forEach((value) => {
  globalStyle(`.grayscale-${value === 100 ? '' : value}`, {
...
// Sepia utilities
[0, 50, 100].forEach((value) => {
  globalStyle(`.sepia-${value === 100 ? '' : value}`, {
...
// Invert utilities
[0, 100].forEach((value) => {
  globalStyle(`.invert-${value === 100 ? '' : value}`, {
