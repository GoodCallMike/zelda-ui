...
globalStyle('.dark .border-gray-300', {
  borderColor: 'var(--gray-600) !important',
});
globalStyle('.dark .bg-gray-50', {
  backgroundColor: 'var(--gray-800) !important',
});
globalStyle('.dark .bg-white', {
  backgroundColor: 'var(--gray-900) !important',
});
...
globalStyle('.dark .border-gray-300', {
  borderColor: 'var(--gray-700) !important',
});
globalStyle('.dark .border-gray-200', {
  borderColor: 'var(--gray-700) !important',
});
