...
export const VideoRecorderOffIcon = ({ className = 'size-4', ...props }: SVGProps<SVGSVGElement>) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
    ...
    aria-label="video recorder off icon"
    {...props}
  >
    <path opacity="0.12" d="M5 19H14C15.3527 19 16.4962 18.1048 16.8705 16.8745L5 5C3.34315 5 2 6.34315 2 8V16C2 17.6569 3.34315 19 5 19Z" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
