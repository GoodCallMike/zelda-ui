...
describe('Select', () => {
  ...
  it('renders with label', () => {
    render(
      <Select options={mockOptions} label="Weapon Type" testId="select" />,
    );
  ...
  it('shows required indicator when required', () => {
    render(
      <Select options={mockOptions} label="Weapon" required testId="select" />,
    );
  ...
  it('selects option when clicked', async () => {
    ...
    render(
      <Select options={mockOptions} onChange={handleChange} testId="select" />,
    );
  ...
  it('renders with different variants', () => {
    const { rerender } = render(
      <Select options={mockOptions} variant="default" testId="select" />,
    );
    expect(screen.getByTestId('select')).toBeInTheDocument();
    ...
    rerender(
      <Select options={mockOptions} variant="borderless" testId="select" />,
    );
    expect(screen.getByTestId('select')).toBeInTheDocument();
  });
  ...
  it('renders with different sizes', () => {
    const { rerender } = render(
      <Select options={mockOptions} size="small" testId="select" />,
    );
    expect(screen.getByTestId('select')).toBeInTheDocument();
  ...
  it('renders with status states', () => {
    const { rerender } = render(
      <Select options={mockOptions} status="error" testId="select" />,
    );
    expect(screen.getByTestId('select')).toBeInTheDocument();
