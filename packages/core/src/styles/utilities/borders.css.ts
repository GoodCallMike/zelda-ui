...
globalStyle('.rounded-t-none', { borderTopLeftRadius: '0px', borderTopRightRadius: '0px' });
globalStyle('.rounded-t-sm', { borderTopLeftRadius: '0.125rem', borderTopRightRadius: '0.125rem' });
globalStyle('.rounded-t', { borderTopLeftRadius: '0.25rem', borderTopRightRadius: '0.25rem' });
globalStyle('.rounded-t-md', { borderTopLeftRadius: '0.375rem', borderTopRightRadius: '0.375rem' });
globalStyle('.rounded-t-lg', { borderTopLeftRadius: '0.5rem', borderTopRightRadius: '0.5rem' });
globalStyle('.rounded-t-xl', { borderTopLeftRadius: '0.75rem', borderTopRightRadius: '0.75rem' });
globalStyle('.rounded-t-2xl', { borderTopLeftRadius: '1rem', borderTopRightRadius: '1rem' });
globalStyle('.rounded-t-3xl', { borderTopLeftRadius: '1.5rem', borderTopRightRadius: '1.5rem' });
globalStyle('.rounded-t-full', { borderTopLeftRadius: '9999px', borderTopRightRadius: '9999px' });

globalStyle('.rounded-r-none', { borderTopRightRadius: '0px', borderBottomRightRadius: '0px' });
globalStyle('.rounded-r-sm', { borderTopRightRadius: '0.125rem', borderBottomRightRadius: '0.125rem' });
globalStyle('.rounded-r', { borderTopRightRadius: '0.25rem', borderBottomRightRadius: '0.25rem' });
globalStyle('.rounded-r-md', { borderTopRightRadius: '0.375rem', borderBottomRightRadius: '0.375rem' });
globalStyle('.rounded-r-lg', { borderTopRightRadius: '0.5rem', borderBottomRightRadius: '0.5rem' });
globalStyle('.rounded-r-xl', { borderTopRightRadius: '0.75rem', borderBottomRightRadius: '0.75rem' });
globalStyle('.rounded-r-2xl', { borderTopRightRadius: '1rem', borderBottomRightRadius: '1rem' });
globalStyle('.rounded-r-3xl', { borderTopRightRadius: '1.5rem', borderBottomRightRadius: '1.5rem' });
globalStyle('.rounded-r-full', { borderTopRightRadius: '9999px', borderBottomRightRadius: '9999px' });

globalStyle('.rounded-b-none', { borderBottomRightRadius: '0px', borderBottomLeftRadius: '0px' });
globalStyle('.rounded-b-sm', { borderBottomRightRadius: '0.125rem', borderBottomLeftRadius: '0.125rem' });
globalStyle('.rounded-b', { borderBottomRightRadius: '0.25rem', borderBottomLeftRadius: '0.25rem' });
globalStyle('.rounded-b-md', { borderBottomRightRadius: '0.375rem', borderBottomLeftRadius: '0.375rem' });
globalStyle('.rounded-b-lg', { borderBottomRightRadius: '0.5rem', borderBottomLeftRadius: '0.5rem' });
globalStyle('.rounded-b-xl', { borderBottomRightRadius: '0.75rem', borderBottomLeftRadius: '0.75rem' });
globalStyle('.rounded-b-2xl', { borderBottomRightRadius: '1rem', borderBottomLeftRadius: '1rem' });
globalStyle('.rounded-b-3xl', { borderBottomRightRadius: '1.5rem', borderBottomLeftRadius: '1.5rem' });
globalStyle('.rounded-b-full', { borderBottomRightRadius: '9999px', borderBottomLeftRadius: '9999px' });

globalStyle('.rounded-l-none', { borderTopLeftRadius: '0px', borderBottomLeftRadius: '0px' });
globalStyle('.rounded-l-sm', { borderTopLeftRadius: '0.125rem', borderBottomLeftRadius: '0.125rem' });
globalStyle('.rounded-l', { borderTopLeftRadius: '0.25rem', borderBottomLeftRadius: '0.25rem' });
globalStyle('.rounded-l-md', { borderTopLeftRadius: '0.375rem', borderBottomLeftRadius: '0.375rem' });
globalStyle('.rounded-l-lg', { borderTopLeftRadius: '0.5rem', borderBottomLeftRadius: '0.5rem' });
globalStyle('.rounded-l-xl', { borderTopLeftRadius: '0.75rem', borderBottomLeftRadius: '0.75rem' });
globalStyle('.rounded-l-2xl', { borderTopLeftRadius: '1rem', borderBottomLeftRadius: '1rem' });
globalStyle('.rounded-l-3xl', { borderTopLeftRadius: '1.5rem', borderBottomLeftRadius: '1.5rem' });
globalStyle('.rounded-l-full', { borderTopLeftRadius: '9999px', borderBottomLeftRadius: '9999px' });
...
// Outline utilities
globalStyle('.outline-none', { outline: '2px solid transparent', outlineOffset: '2px' });
...
globalStyle('.ring-inset', { boxShadow: 'inset 0 0 0 2px rgb(59 130 246 / 0.5)' });

// Ring offset
globalStyle('.ring-offset-0', { boxShadow: '0 0 0 0px var(--tw-ring-offset-color), 0 0 0 2px rgb(59 130 246 / 0.5)' });
globalStyle('.ring-offset-1', { boxShadow: '0 0 0 1px var(--tw-ring-offset-color), 0 0 0 3px rgb(59 130 246 / 0.5)' });
globalStyle('.ring-offset-2', { boxShadow: '0 0 0 2px var(--tw-ring-offset-color), 0 0 0 4px rgb(59 130 246 / 0.5)' });
globalStyle('.ring-offset-4', { boxShadow: '0 0 0 4px var(--tw-ring-offset-color), 0 0 0 6px rgb(59 130 246 / 0.5)' });
globalStyle('.ring-offset-8', { boxShadow: '0 0 0 8px var(--tw-ring-offset-color), 0 0 0 10px rgb(59 130 246 / 0.5)' });